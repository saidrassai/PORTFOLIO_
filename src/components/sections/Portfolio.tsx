...
const Portfolio = () => {
  ...
  return (
    <section ref={sectionRef} id="portfolio" className="min-h-screen py-20 px-6 bg-white relative overflow-hidden" data-theme="light">
      {/* Light background matching About section */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-blue-50/30" />
      
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Section Title */}
        <div className="text-center mb-16">          <h2 ref={titleRef} className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">
            Project
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600"> Releases</span>
          </h2>
        ...
        <div ref={carouselRef} className="relative">          {/* Simplified Carousel Container */}
                  ...
                  >
                    <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
                      ...
                      <div className="relative group">
                        <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${project.gradient} p-1`}>                          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 h-96 flex flex-col justify-center items-center relative overflow-hidden border border-gray-200">
                            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-gray-50/50 to-blue-50/30" />
                            <div className="relative z-10 text-center">
                              <div className="w-24 h-24 mx-auto mb-6 bg-gray-100 rounded-2xl flex items-center justify-center border border-gray-200">
                                <IconComponent size={40} className="text-gray-800" />
                              </div>
                              <h3 className="text-3xl font-bold text-gray-900 mb-2">{project.title}</h3>
                              <div className="flex items-center justify-center gap-2 mb-4">
                                <span className="text-sm font-mono text-gray-600">{project.version}</span>
                            ...
                            </div>                              {/* Simplified particles effect */}
                      ...
                      <div className="space-y-6">                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 capitalize">{project.category} Development</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {project.tech.map((tech, idx) => (
                              <span 
                                key={idx} 
                                className="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm border border-gray-200 hover:border-gray-300 hover:bg-gray-200 transition-colors"
                              >
                                {tech}
                              </span>
                            ))}
                        ...
                        <div className="flex gap-4 pt-4">
                          {project.demo && (
                            ...
                            <a
                              href={project.github}
                              className="inline-flex items-center gap-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all duration-300 font-medium"
                            >
                              <Github size={16} />
          ...
          <div className="flex items-center justify-between mt-8">
            {/* Navigation Arrows */}            <div className="flex gap-4">
              <button
                onClick={prevSlide}
                className="w-12 h-12 bg-white/80 hover:bg-white border border-gray-200 rounded-xl flex items-center justify-center text-gray-600 hover:text-gray-900 transition-all duration-300 backdrop-blur-sm shadow-sm"
              >
                <ChevronLeft size={20} />
              </button>
              <button
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                {projects.map((_, index) => (
                  <button
                    key={index}
                    onClick={() => goToSlide(index)}                      className={`transition-all duration-300 ${
                      currentSlide === index 
            ...
            {/* Auto-play Toggle */}
            <button
              onClick={() => setIsAutoPlay(!isAutoPlay)}              className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 backdrop-blur-sm border shadow-sm ${
                isAutoPlay 
                  ? 'bg-blue-50 border-blue-200 text-blue-600' 
                  : 'bg-white/80 border-gray-200 text-gray-600 hover:text-gray-900 hover:bg-white'
              }`}
            >
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-3 px-8 py-4 bg-white/80 rounded-2xl border border-gray-200 backdrop-blur-sm shadow-sm">
            <Code size={20} className="text-cyan-500" />
            <span className="text-gray-700 font-medium">More innovative projects in development...</span>
